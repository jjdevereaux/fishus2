...
public class FishermanController : EntityController
{
    ...
    public void Spawn(Fisherman fisherman, PlayerController owner)
    {
        base.Spawn(fisherman.EntityId);
		SetColor(ColorPalette[fisherman.PlayerId % ColorPalette.Length]);
